...
export const courses: Course[] = [
  ...
  { name: "Ciência de Dados", institution: "Faculdade Líbano", details: "EAD", type: "Pós-graduação", status: "Cursando", schedule: "Noite", finish: "2026" },
  { name: "Robótica e Inteligência Artificial", institution: "Faculdade Líbano", details: "EAD", type: "Pós-graduação", status: "Cursando", schedule: "Noite", finish: "2026" },
